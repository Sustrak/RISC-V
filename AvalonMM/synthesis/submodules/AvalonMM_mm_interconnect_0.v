...
module AvalonMM_mm_interconnect_0 (
		...
		input  wire        leg_g_reset_reset_bridge_in_reset_reset,            //            leg_g_reset_reset_bridge_in_reset.reset
	...
	wire  [103:0] cmd_demux_001_src1_data;                                               // cmd_demux_001:src1_data -> crosser_002:in_data
	wire          cmd_demux_001_src1_ready;                                              // crosser_002:in_ready -> cmd_demux_001:src1_ready
	wire    [2:0] cmd_demux_001_src1_channel;                                            // cmd_demux_001:src1_channel -> crosser_002:in_channel
	...
	wire  [103:0] crosser_002_out_data;                                                  // crosser_002:out_data -> cmd_mux_001:sink1_data
	wire          crosser_002_out_ready;                                                 // cmd_mux_001:sink1_ready -> crosser_002:out_ready
	wire    [2:0] crosser_002_out_channel;                                               // crosser_002:out_channel -> cmd_mux_001:sink1_channel
	...
	wire  [103:0] cmd_demux_001_src2_data;                                               // cmd_demux_001:src2_data -> crosser_003:in_data
	wire          cmd_demux_001_src2_ready;                                              // crosser_003:in_ready -> cmd_demux_001:src2_ready
	wire    [2:0] cmd_demux_001_src2_channel;                                            // cmd_demux_001:src2_channel -> crosser_003:in_channel
	...
	wire  [103:0] crosser_003_out_data;                                                  // crosser_003:out_data -> cmd_mux_002:sink1_data
	wire          crosser_003_out_ready;                                                 // cmd_mux_002:sink1_ready -> crosser_003:out_ready
	wire    [2:0] crosser_003_out_channel;                                               // crosser_003:out_channel -> cmd_mux_002:sink1_channel
	...
	wire  [103:0] rsp_demux_001_src0_data;                                               // rsp_demux_001:src0_data -> crosser_004:in_data
	...
	wire  [103:0] crosser_004_out_data;                                                  // crosser_004:out_data -> rsp_mux:sink1_data
	...
	wire  [103:0] rsp_demux_001_src1_data;                                               // rsp_demux_001:src1_data -> crosser_005:in_data
	wire          rsp_demux_001_src1_ready;                                              // crosser_005:in_ready -> rsp_demux_001:src1_ready
	wire    [2:0] rsp_demux_001_src1_channel;                                            // rsp_demux_001:src1_channel -> crosser_005:in_channel
	...
	wire  [103:0] crosser_005_out_data;                                                  // crosser_005:out_data -> rsp_mux_001:sink1_data
	wire          crosser_005_out_ready;                                                 // rsp_mux_001:sink1_ready -> crosser_005:out_ready
	wire    [2:0] crosser_005_out_channel;                                               // crosser_005:out_channel -> rsp_mux_001:sink1_channel
	...
	wire  [103:0] rsp_demux_002_src0_data;                                               // rsp_demux_002:src0_data -> crosser_006:in_data
	wire          rsp_demux_002_src0_ready;                                              // crosser_006:in_ready -> rsp_demux_002:src0_ready
	wire    [2:0] rsp_demux_002_src0_channel;                                            // rsp_demux_002:src0_channel -> crosser_006:in_channel
	...
	wire  [103:0] crosser_006_out_data;                                                  // crosser_006:out_data -> rsp_mux:sink2_data
	wire          crosser_006_out_ready;                                                 // rsp_mux:sink2_ready -> crosser_006:out_ready
	wire    [2:0] crosser_006_out_channel;                                               // crosser_006:out_channel -> rsp_mux:sink2_channel
	...
	wire  [103:0] rsp_demux_002_src1_data;                                               // rsp_demux_002:src1_data -> crosser_007:in_data
	wire          rsp_demux_002_src1_ready;                                              // crosser_007:in_ready -> rsp_demux_002:src1_ready
	wire    [2:0] rsp_demux_002_src1_channel;                                            // rsp_demux_002:src1_channel -> crosser_007:in_channel
	...
	wire  [103:0] crosser_007_out_data;                                                  // crosser_007:out_data -> rsp_mux_001:sink2_data
	wire          crosser_007_out_ready;                                                 // rsp_mux_001:sink2_ready -> crosser_007:out_ready
	wire    [2:0] crosser_007_out_channel;                                               // crosser_007:out_channel -> rsp_mux_001:sink2_channel
	...
	wire          leg_g_s1_agent_rdata_fifo_out_valid;                                   // leg_g_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] leg_g_s1_agent_rdata_fifo_out_data;                                    // leg_g_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          leg_g_s1_agent_rdata_fifo_out_ready;                                   // avalon_st_adapter_001:in_0_ready -> leg_g_s1_agent_rdata_fifo:out_ready
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (leg_g_reset_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                             //             clk.clk
		.reset                   (leg_g_reset_reset_bridge_in_reset_reset),   //       clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (leg_g_reset_reset_bridge_in_reset_reset),     // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (leg_g_reset_reset_bridge_in_reset_reset),     //  in_clk_reset.reset
	...
	AvalonMM_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (leg_g_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
