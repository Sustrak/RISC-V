...
module AvalonMM_mm_interconnect_0 (
	...
	wire  [105:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> sdram_controller_s1_agent:cp_data
	wire          cmd_mux_src_ready;                                                     // sdram_controller_s1_agent:cp_ready -> cmd_mux:src_ready
	wire    [4:0] cmd_mux_src_channel;                                                   // cmd_mux:src_channel -> sdram_controller_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_001_src_data;                                                  // cmd_mux_001:src_data -> leg_g_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                 // leg_g_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [4:0] cmd_mux_001_src_channel;                                               // cmd_mux_001:src_channel -> leg_g_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_002_src_data;                                                  // cmd_mux_002:src_data -> switch_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                 // switch_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [4:0] cmd_mux_002_src_channel;                                               // cmd_mux_002:src_channel -> switch_s1_agent:cp_channel
	...
	wire  [105:0] cmd_mux_003_src_data;                                                  // cmd_mux_003:src_data -> key_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                 // key_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [4:0] cmd_mux_003_src_channel;                                               // cmd_mux_003:src_channel -> key_s1_agent:cp_channel
	...
	wire          cmd_mux_004_src_valid;                                                 // cmd_mux_004:src_valid -> led_r_s1_agent:cp_valid
	wire  [105:0] cmd_mux_004_src_data;                                                  // cmd_mux_004:src_data -> led_r_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                 // led_r_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [4:0] cmd_mux_004_src_channel;                                               // cmd_mux_004:src_channel -> led_r_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                         // cmd_mux_004:src_startofpacket -> led_r_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                           // cmd_mux_004:src_endofpacket -> led_r_s1_agent:cp_endofpacket
	...
	wire  [105:0] sdram_controller_s1_agent_rp_data;                                     // sdram_controller_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [105:0] leg_g_s1_agent_rp_data;                                                // leg_g_s1_agent:rp_data -> router_003:sink_data
	...
	wire  [105:0] switch_s1_agent_rp_data;                                               // switch_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [105:0] key_s1_agent_rp_data;                                                  // key_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [105:0] led_r_s1_agent_rp_data;                                                // led_r_s1_agent:rp_data -> router_006:sink_data
	...
	wire    [4:0] router_src_channel;                                                    // router:src_channel -> mm_bridge_m0_limiter:cmd_sink_channel
	...
	wire    [4:0] mm_bridge_m0_limiter_cmd_src_channel;                                  // mm_bridge_m0_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire    [4:0] rsp_mux_src_channel;                                                   // rsp_mux:src_channel -> mm_bridge_m0_limiter:rsp_sink_channel
	...
	wire    [4:0] mm_bridge_m0_limiter_rsp_src_channel;                                  // mm_bridge_m0_limiter:rsp_src_channel -> mm_bridge_m0_agent:rp_channel
	...
	wire    [4:0] mm_bridge_m0_limiter_cmd_valid_data;                                   // mm_bridge_m0_limiter:cmd_src_valid -> cmd_demux:sink_valid
	...
	wire          led_r_s1_agent_rdata_fifo_src_valid;                                   // led_r_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] led_r_s1_agent_rdata_fifo_src_data;                                    // led_r_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          led_r_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_004:in_0_ready -> led_r_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                     // avalon_st_adapter_004:out_0_valid -> led_r_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                      // avalon_st_adapter_004:out_0_data -> led_r_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                     // led_r_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                     // avalon_st_adapter_004:out_0_error -> led_r_s1_agent:rdata_fifo_sink_error
