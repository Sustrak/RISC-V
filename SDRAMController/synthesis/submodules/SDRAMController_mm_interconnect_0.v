// SDRAMController_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module SDRAMController_mm_interconnect_0 (
		...
		input  wire [26:0] mm_bridge_m0_address,                               //                                 mm_bridge_m0.address
	...
	wire  [101:0] rsp_mux_src_data;                                                      // rsp_mux:src_data -> mm_bridge_m0_agent:rp_data
	wire          rsp_mux_src_ready;                                                     // mm_bridge_m0_agent:rp_ready -> rsp_mux:src_ready
	wire    [1:0] rsp_mux_src_channel;                                                   // rsp_mux:src_channel -> mm_bridge_m0_agent:rp_channel
	...
	wire          rsp_mux_001_src_valid;                                                 // rsp_mux_001:src_valid -> jtag_master_master_agent:rp_valid
	wire  [101:0] rsp_mux_001_src_data;                                                  // rsp_mux_001:src_data -> jtag_master_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                 // jtag_master_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [1:0] rsp_mux_001_src_channel;                                               // rsp_mux_001:src_channel -> jtag_master_master_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                         // rsp_mux_001:src_startofpacket -> jtag_master_master_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                           // rsp_mux_001:src_endofpacket -> jtag_master_master_agent:rp_endofpacket
	...
	wire  [102:0] sdram_controller_s1_agent_rf_source_data;                              // sdram_controller_s1_agent:rf_source_data -> sdram_controller_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] sdram_controller_s1_agent_rsp_fifo_out_data;                           // sdram_controller_s1_agent_rsp_fifo:out_data -> sdram_controller_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_src_data;                                                      // cmd_mux:src_data -> sdram_controller_s1_agent:cp_data
	wire          cmd_mux_src_ready;                                                     // sdram_controller_s1_agent:cp_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                                   // cmd_mux:src_channel -> sdram_controller_s1_agent:cp_channel
	...
	wire  [101:0] mm_bridge_m0_agent_cp_data;                                            // mm_bridge_m0_agent:cp_data -> router:sink_data
	...
	wire  [101:0] jtag_master_master_agent_cp_data;                                      // jtag_master_master_agent:cp_data -> router_001:sink_data
	...
	wire  [101:0] sdram_controller_s1_agent_rp_data;                                     // sdram_controller_s1_agent:rp_data -> router_002:sink_data
	...
	SDRAMController_mm_interconnect_0_router router (
	...
	SDRAMController_mm_interconnect_0_router router_001 (
	...
	SDRAMController_mm_interconnect_0_router_002 router_002 (
	...
	SDRAMController_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (sdram_pll_sys_clk_clk),                       //       clk.clk
		.reset              (mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDRAMController_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (sdram_pll_sys_clk_clk),                       //       clk.clk
		.reset              (mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDRAMController_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (sdram_pll_sys_clk_clk),                              //       clk.clk
		.reset               (sdram_controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDRAMController_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (sdram_pll_sys_clk_clk),                              //       clk.clk
		.reset              (sdram_controller_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDRAMController_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (sdram_pll_sys_clk_clk),                       //       clk.clk
		.reset               (mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDRAMController_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (sdram_pll_sys_clk_clk),                       //       clk.clk
		.reset               (mm_bridge_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	SDRAMController_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
